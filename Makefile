...
compile-macos-x86:
	...
	gcc -O3 $(MACOS_FLAGS) -I src src/sqlite3-text.c -o dist/x86/text.dylib -target x86_64-apple-macos10.12
...
compile-macos-arm64:
	...
	gcc -O3 $(MACOS_FLAGS) -I src src/sqlite3-text.c -o dist/arm64/text.dylib -target arm64-apple-macos11
